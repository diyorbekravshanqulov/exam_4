...
import { PatientMailService } from './PatientMail.service';
import { DcotorMailService } from './DoctorMail.service';
...
@Module({
  ...
  providers: [AdminMailService, PatientMailService, DcotorMailService],
  exports: [AdminMailService, PatientMailService, DcotorMailService],
})
